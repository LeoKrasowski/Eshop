...
import com.myproject.shop.db.service.mapper.BoughtProductRowMapper;
...
public class BoughtProductRepository{
    ...
    public void add(BoughtProduct boughtProduct){
        ...
        jdbcTemplate.update(sql, boughtProduct.getProductId(), boughtProduct.getCustomerId(), boughtProduct.getQuantity(),
